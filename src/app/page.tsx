...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="relative bg-gradient-to-b from-[hsl(220,60%,15%)] to-[hsl(220,50%,22%)] text-white py-24 sm:py-32">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <div className="flex justify-center mb-6">
            <div className="rounded-full bg-[hsl(43,74%,49%)]/20 p-4">
              <Scale className="h-12 w-12 text-[hsl(43,74%,49%)]" />
            </div>
          </div>
          ...
          <form onSubmit={handleSearch} className="mt-10 flex gap-2 max-w-2xl mx-auto">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10 h-12 bg-white/10 border-white/20 text-white placeholder:text-white/40 focus-visible:ring-[hsl(43,74%,49%)]"
              />
            </div>
            <Button type="submit" className="h-12 px-8 bg-[hsl(43,74%,49%)] text-[hsl(220,60%,12%)] hover:bg-[hsl(43,74%,59%)] font-semibold">
              Search
            </Button>
          </form>
      ...
      <section className="py-16 bg-secondary/30">
        <div className="mx-auto max-w-6xl px-4 text-center">
          <h2 className="text-2xl font-bold text-[hsl(220,60%,20%)] mb-8">Courts Covered</h2>
          <div className="flex flex-wrap justify-center gap-4">
            {["Constitutional Court", "Supreme Court of Appeal", "High Court — Gauteng", "High Court — Western Cape", "High Court — KwaZulu-Natal", "Labour Court", "Land Claims Court", "Competition Appeal Court"].map((c) => (
              <div key={c} className="flex items-center gap-2 bg-white rounded-lg px-4 py-3 shadow-sm border">
                <Building2 className="h-4 w-4 text-[hsl(220,60%,20%)]" />
